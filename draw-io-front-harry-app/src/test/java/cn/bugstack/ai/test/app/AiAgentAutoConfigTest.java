...
public class AiAgentAutoConfigTest {
    ...
    @Test
    public void test_handlerMessage_02() throws InterruptedException {
    ...
    @Test
    public void test_handlerMessage_03() throws InterruptedException {
        ...
        Content userMsg = Content.fromParts(Part.fromText("把harry转换为大写"));
        Flowable<Event> events = runner.runAsync("xiaofuge", session.id(), userMsg);
